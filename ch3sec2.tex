...
In the following problems, find a basis of the image of the matrices.
...
\begin{solution}
The two column vectors are linearly independent, so they form a basis for the image of the matrix.
...
The image of the matrix is a plane passing through the origin.
